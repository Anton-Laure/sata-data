        ...
        <div class="relative max-w-7xl mx-auto px-6 py-10 lg:py-10">
            <div class="lg:flex lg:items-center lg:gap-12">
                <div class="relative z-10 mt-10 items-center text-center  max-w-5xl mx-auto lg: lg:w-full">
                    ...
                    <h1 class="mt-10 text-title font-bold text-balance text-4xl md:text-5xl xl:text-5xl">Organisasi</h1>
                    <p class="mt-8 text-body">Dapatkan daftar Perangkat Daerah (PD) yang berkontribusi dalam membangun ekosistem data yang terbuka dan terpercaya melalui publikasi data di Open Data Nusa Tenggara Timur.</p>
                    <div>
        ...
        <div class="pt-0">
            ...
            <div class="mx-auto px-6 max-w-7xl">
                ...
                <div class="mt-12 relative w-full h-fit sm:mx-auto sm:px-0 -mx-6 px-6 ">
                    <div>
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4">
