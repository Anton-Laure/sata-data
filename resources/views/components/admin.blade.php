...
<html lang="en" dir="ltr" data-bs-theme="light" data-bs-theme-color="theme-color-default">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="{{ asset('admin/css/hope-ui.min.css?v=5.0.0') }}">
      
      <!-- Custom Css -->
      <link rel="stylesheet" href="{{ asset('admin/css/custom.min.css?v=5.0.0') }}">
      
      <!-- Customizer Css -->
      <link rel="stylesheet" href="{{ asset('admin/css/customizer.min.css?v=5.0.0') }}">
      
      <!-- RTL Css -->
      <link rel="stylesheet" href="{{ asset('admin/css/rtl.min.css?v=5.0.0') }}">
