                ...
                <div class="grid gap-12 md:gap-0 md:grid-cols-2 items-center lg:gap-12">
                    <div class="lg:pr-12">
                        <div class="md:pr-6 lg:pr-0">
                            <h2 class="  text-center rounded-full bg-gradient-to-br from-yellow-400 to-yellow-500 px-3 py-3   text-white shadow-md mb-2 font-semibold"> Profil Singkat SDI Nusa Tenggara Timur</h2> 
                                {{-- <h2 class="absolute  mb-0  h-8  rounded-full bg-gradient-to-br from-yellow-400 to-yellow-500 px-3 py-1   text-white shadow-md">Profil Singkat SDI Nusa Tenggara Timur</h2> --}}
                            <p class="mt-3 text-body text-justify ">Satu Data NTT adalah inisiatif Pemerintah Provinsi Nusa Tenggara Timur (NTT) untuk menerapkan kebijakan Satu Data Indonesia (SDI) di tingkat daerah. Tujuannya adalah menciptakan tata kelola data yang akurat, mutakhir, terpadu, dan dapat dipertanggungjawabkan, guna mendukung perencanaan, pelaksanaan, evaluasi, dan pengendalian pembangunan di NTT.</p>
                        </div>
                        <ul class="mt-8 divide-y border-y *:py-3 *:flex *:items-center *:gap-3">
                            <li>
                                ...
                                <span class="text-xs">Pembina </span><b>Badan Pusat Statistik Prov. NTT</b>
                            </li>
                            <li>
                                {{-- <svg class="size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                               ...
                               <span class="text-xs"> Koordinator </span><b>Bapperida Prov. NTT</b>
                            </li>
                            <li>
                                ...
                                <span class="text-xs">Walidata</span><b>Diskominfo Prov. NTT</b>
                            </li>
                            <li >
                                {{-- <svg class="size-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                ...
                                <span class="text-xs"> Produsen Data</span><b>Instansi Pemerintah Tingkat Prov. NTT</b>
                            </li>
                        </ul>
                    </div>
                    <div class="overflow-hidden p-3 card variant-outlined">
                        ...
                        <div class="flex gap-3 px-[--card-padding] *:aspect-square *:p-4">
                            <img class="h-1/2 " src="gub-new.jpg" >
                        </div>
                        <div>
