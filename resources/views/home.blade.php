        ...
        <section class="overflow-hidden mt-10">
            ...
            <div class="relative max-w-7xl mx-auto px-6 py-28 lg:py-20">
                <div class="lg:flex lg:items-center lg:gap-12">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex  items-center">
                                        ...
                                        <p class=" ps-2 ">Total Dataset</p>

                                    </div>
                                    <div class="  text-2xl font-bold">14785</div>
                                </div>
                                <div
                                    class="col-span-2 sm:col-span-1 card text-white bg-primary-500 shadow-lg px-4 py-5">
                                    <div class="flex  items-center">
                                        ...
                                        <p class=" ps-2">Total Infografik</p>

                                    </div>
                                    <div class=" text-2xl font-bold">564</div>
                                </div>
                                <div
                                    class="col-start-2 sm:col-start-0 col-span-2 sm:col-span-1 card text-white bg-primary-500 shadow-lg px-4 py-5">
                                    <div class="flex  items-center">
                                        ...
                                        <p class=" ps-2">Total Organisasi</p>

                                    </div>
                                    <div class="  text-2xl font-bold">154</div>
                                </div>
                    ...
                    <div
                        class="relative lg:absolute inset-x-0 right-6 mt-2 lg:mt-2 lg:inset-y-16 h-fit mx-auto lg:mr-0 ml-auto max-w-md [--ui-shadow-border:var(--ui-border-color)]  ">

                        <div
                            class="absolute -inset-20 sm:-inset-40 z-[1] bg-gradient-to-b from-white via-transparent to-gray-50 dark:from-gray-950 dark:via-transparent dark:to-gray-950 ">
                        </div>
                        <div
                            class="absolute -inset-20 sm:-inset-40 z-[1] bg-gradient-to-r from-white via-transparent to-gray-50 dark:from-gray-950 dark:via-transparent dark:to-gray-950">
                        </div>
                        ...
                        <div class="relative group overflow-hidden card variant-outlined">
                            ...
                            <div class="relative ">
                                <div class="flex justify-center items-center">
                                    <div
                                        class="flex-none w-12 badge variant-outlined flex relative *:relative *:size-6 *:m-auto size-12 ">
                                        <img width="96" height="96"
                                            src="https://img.icons8.com/lollipop/96/xls.png" alt="xls" />

                                    </div>
                                    <h3 class="flex-auto ps-3 text-xl font-semibold">Jumlah Rumah Tangga Perikanan (RTP)</h3>
                                </div>
                                <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                    <p class="text-body">Dinas Kelautan dan Perikanan Provinsi NTT</p>
                                </div>

                                <div
                                    class="flex gap-3 items-center place-content-between -mb-[--card-padding] py-4 border-t">
                                    <h4 class="text-green-600 btn bg-green-100   sz-sm">Terbuka
                                    </h4>
                        ...
                        <div class="relative group overflow-hidden card variant-outlined">
                            ...
                            <div class="relative ">
                                <div class="flex justify-center items-center">
                                    ...
                                    <h3 class="flex-auto ps-3 text-xl font-semibold">Jumlah Produksi Hasil Hutan Kayu dalam wilayah Provinsi NTT</h3>
                                </div>
                                <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                    <p class="text-body">DLHK Prov NTT</p>
                                </div>
                        ...
                        <div class="relative group overflow-hidden card variant-outlined">
                            ...
                            <div class="relative ">
                                <div class="flex justify-center items-center">
                                    ...
                                    <h3 class="flex-auto ps-3 text-xl font-semibold">Jumlah pokdarwis di NTT menurut kabupaten/kota</h3>
                                </div>
                                <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                    <p class="text-body">Dinas Parekraf Kab/Kota</p>
                                </div>
                        ...
                        <div class="relative group overflow-hidden card variant-outlined">
                            ...
                            <div class="relative ">
                                <div class="flex justify-center items-center">
                                    ...
                                    <h3 class="flex-auto ps-3 text-xl font-semibold">Jumlah Perolehan Medali Cabang Olahraga Prestasi Dan Pendidikan</h3>
                                </div>
                                <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                    <p class="text-body">Dinas Kepemudaan dan Olahraga</p>
                                </div>
                        ...
                        <div class="relative group overflow-hidden card variant-outlined">
                            ...
                            <div class="relative ">
                                <div class="flex justify-center items-center">
                                    ...
                                    <h3 class="flex-auto ps-3 text-xl font-semibold">Jumlah Titik Yang Terkoneksi Jaringan Pemda NTT</h3>
                                </div>
                                <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                    <p class="text-body">Dinas Komunikasi dan Informatika  NTT</p>
                                </div>
                        ...
                        <div class="relative group overflow-hidden card variant-outlined">
                            ...
                            <div class="relative ">
                                <div class="flex justify-center items-center">
                                    ...
                                    <h3 class="flex-auto ps-3 text-xl font-semibold">Indeks Sistem Pemerintahan Berbasis Elektronik (SPBE)</h3>
                                </div>
                                <div class="mt-6 pb-6 rounded-b-[--card-border-radius]">
                                    <p class="text-body">Dinas Komunikasi dan Informatika  NTT</p>
                                </div>
